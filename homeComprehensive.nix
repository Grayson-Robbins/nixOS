...
{ 
  ...
  # colorScheme = nix-colors.colorSchemes.dracula; # Example scheme used in nix-colors github readme
  programs.kitty = {
    enable = true;
    # settings = {
    ...
    qutebrowser = {
      ...
      settings = {
        colors = {
   	  ...
   	  # webpage.preferred_color_scheme = "${config.colorScheme.variant}"; # I don't believe this line works
	 # webpage.bg = "${config.colorScheme.variant}";
   	  # tabs.bar.bg = "#${config.colorScheme.palette.base00}";
   	  # keyhint.fg = "#${config.colorScheme.palette.base05}";
	  # hints.bg = "#${config.colorScheme.palette.base05}";
        };
      };
    };
